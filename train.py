...
from mixed_folder import MixedDatasetFolder
...
if True:  # for debugging
    train_set = MixedDatasetFolder(os.path.join(IMAGENET_ADV, 'train/'), os.path.join(IMAGENET_CLEAN, 'train/'),
                                   p=args.prob, loader=np.load, extensions=['.npy'], transform=torch.from_numpy)
